 ...
 *
 * Disassembly of SSDT8.aml, Wed Sep 22 14:35:49 2021
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00001A91 (6801)
 *     Revision         0x01
 *     Checksum         0x22
 *     OEM ID           "OptRef"
...
DefinitionBlock ("", "SSDT", 1, "OptRef", "OptTabl", 0x00001000)
{
    ...
    External (_SB_.PCI0.LPCB.EC0_.GPST, FieldUnitObj)
    External (_SB_.PCI0.LPCB.EC0_.SLMS, IntObj)
        ...
        Method (GPS, 4, Serialized)
        {
            ...
            While (One)
            {
                ...
                ElseIf (LEqual (_T_0, 0x13))
                {
                    ...
                    If (LAnd (ToInteger (PPST), \GP12))
                    {
                        Store (One, \_SB.PCI0.LPCB.EC0.GPST)
                        Store (Zero, \GP12)
                    }
                ...
                ElseIf (LEqual (_T_0, 0x22))
                {
                    ...
                    If (\_SB.PCI0.LPCB.EC0.SLMS)
                    {
                        If (LLessEqual (PCAP, 0x0A))
                        {
                            Store (0x0A, PCAP)
                        }
                    }

                    If (LAnd (LEqual (\_SB.PCI0.LPCB.EC0.XCIN, Zero), LEqual (\_SB.PCI0.LPCB.EC0.XTIN, One)))
                    {
                        If (LLess (PCAP, 0x08))
                        {
                            Store (0x0F, PCAP)
    ...
    Scope (\)
    {
        OperationRegion (GPIO, SystemIO, 0x1C00, 0x60)
